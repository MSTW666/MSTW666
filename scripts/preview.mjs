...
const pick = (theme, mobile) =>
  files
    .filter((f) => f.endsWith("-m.svg") === mobile)
...
<style>
  ...
  section.dark{color-scheme:dark;background:#0D1117;color:#8B949E}
  section.light{color-scheme:light;background:#fff;color:#57606A}
